...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("image/About.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("image/Run.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRun->setIcon(icon6);
        actionSetting = new QAction(MainWindow);
        actionSetting->setObjectName(QString::fromUtf8("actionSetting"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("image/Setting.png"), QSize(), QIcon::Normal, QIcon::Off);
